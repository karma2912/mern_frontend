  ...
  return (
    ...
    {!modal && <div className='md:h-5/6 h-[45rem] w-4/5 bg-red-400 rounded-[6rem] flex flex-col justify-around items-center p-8'>
      ...
      <div className='w-full flex justify-evenly items-center'>
        <button className='md:text-2xl text-xl border-2 border-black md:p-2 p-1 rounded-xl bg-green-500 md:w-32 w-24 flex justify-around items-center hover:bg-green-700' onClick={handleback}><i className="fa-solid fa-arrow-left"></i>Back</button>
        <button className='md:text-2xl text-xl border-2 border-black md:p-2 p-1 rounded-xl bg-green-500 md:w-32 w-24 flex justify-around items-center hover:bg-green-700' onClick={handleNext}>Start<i className="fa-solid fa-arrow-right"></i></button>
      </div>
    </div>}
