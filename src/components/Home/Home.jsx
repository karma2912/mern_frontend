...
const Home = () => {
  ...
  return (
   ...
   <div className='black-curve h-[40rem] w-full bg-black flex justify-around items-center rounded-b-[15rem] shadow-xl text-yellow-400'>
    <div className='md:text-7xl text-5xl font-bold md:p-16 p-8 flex flex-col justify-start md:items-start items-center'><span className="quiz-head" >Daily Quiz, Daily<br/>
    ...
    <Link className='button text-xl font-normal border-2 mt-5 border-black bg-green-400 p-2 rounded-xl text-black' to="/test"><i className="fa-regular fa-circle-play mr-2"></i>PLAY NOW</Link>
    </div>
