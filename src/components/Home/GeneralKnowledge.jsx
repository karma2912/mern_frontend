...
const GeneralKnowledge = () => {
  return (
    <div className='md:h-full h-[82rem] md:w-11/12 w-full flex md:flex-row flex-col justify-between items-center rounded-2xl'>
      ...
      <div className='md:text-5xl text-4xl md:w-[55rem] w-11/12 bg-yellow-300 md:font-bold font-extrabold md:p-16 p-10 rounded-2xl border-2 border-yellow-500 shadow-2xl'>General Knowledge
