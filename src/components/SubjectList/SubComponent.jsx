    ...
    <>
      <div className="component h-90 w-5/6 text-black p-3 m-5 flex flex-col justify-around sm:flex-row  border-2 bg-indigo-400 border-indigo-600 rounded-2xl hover:w-11/12 hover:transition duration-300 hover:border-4 hover:shadow-2xl hover:border-indigo-600">
        <div>
          <img
            src={props.img}
            className="h-72 lg:w-80 md:w-48 w-full rounded-full "
          ></img>
        </div>
          ...
          <div className="p-1">
            ...
            <div className="pt-2">
              <div className="w-full font-semibold text-lg  pb-4 flex justify-evenly items-center">
                <div>Easy</div>{" "}
                <i className="fa-solid fa-arrow-right md:ml-0 ml-2"></i>
                <Link
                  className="bg-white p-1 border-2 rounded-xl border-black text-green-500 hover:bg-slate-300"
                  onClick={handleEasy}
                  to={`${props.to}etest`}
                >
              ...
              <div className="w-full font-semibold text-lg pb-4 flex justify-evenly items-center">
                ...
                <Link
                  className="bg-white p-1 border-2 border-black rounded-xl text-green-500 hover:bg-slate-300"
              ...
              <div className="w-full font-semibold text-lg pb-4 flex justify-evenly items-center">
                <div>Hard</div>{" "}
                <i className="fa-solid fa-arrow-right md:ml-3 ml-1"></i>
                <Link
                  className="bg-white p-1 border-2 border-black rounded-xl text-green-500 hover:bg-slate-300"
                  onClick={handleHard}
                  to={`${props.to}htest`}
